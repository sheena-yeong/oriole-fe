  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={onClose}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-1/2 top-1/2 w-[90%] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl bg-neutral-200 p-8 shadow-lg z-50">
          <div className="flex flex-col items-center text-center">
            ...
            <DialogPrimitive.Description className="text-neutral-600 mb-4">
